...
function initialization() {
    ...
    document.getElementById('param_D').value = "1";
    ...
    document.getElementById('param_alpha').value = "1.6";
    document.getElementById('param_Vd0').value = "0";
    //param_gated
    document.getElementById('param_W_gated').value = "100";
    document.getElementById('param_L_gated').value = "5";
    ...
    document.getElementById('param_Q0').value = "1.26e-8";
    document.getElementById('param_Q0_rate').value = "1";
    document.getElementById('param_Rmid0').value = "4.0e7"
...
function scanning() {
    ...
    this.R_back_real = parseFloat(document.getElementById('param_Rmid0').value);
    ...
    this.power2 = 0.18;
    this.R_power = -1;
    this.D_hole = parseFloat(document.getElementById('param_D').value);
    ...
    if (this.Voltage_scanType) {       //Vd
        ...
        for (i = 1; i < 200; i++) {
            ...
            this.R_ll[i] = this.R_back_real * Math.pow(this.Voltage_drain_minus_drain0[i], this.R_power) / (this.D_hole * 1e-4) * ((this.L_gated + this.d_nongated + this.d_nongated2) * 1e-4);
        }
    ...
    for (i = 1; i < 200; i++) {
        ...
        this.b1[i] = -2 * this.alpha * this.gamma12_data[i] * Math.pow(this.Voltage_2[i], this.alpha - 1) - 2 * this.Voltage_gate_minus_threshold[i] + 2 * this.Voltage_2[i];
    ...
    for (i = 1; i < 200; i++) {
        this.I_drain_tot[i] = this.Voltage_drain_minus_drain0[i] / this.R_ll[i] + this.I_drain[i];
