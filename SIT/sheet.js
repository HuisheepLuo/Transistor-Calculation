function dataExport(data) {
    ...
    var aoa_data = [];
    //param
    aoa_param.push(['W_nongated[μm]',data.W_nongated]);
    aoa_param.push(['d_nongated[μm]',data.d_nongated]);
    aoa_param.push(['d_nongated3[μm]',data.d_nongated2]);
    aoa_param.push(['tacc[nm]',data.tsc_nongated]);
    aoa_param.push(['D[μm]',data.D_hole]);
    ...
    aoa_param.push(['ρmid0',data.R_back_real]);
    //
